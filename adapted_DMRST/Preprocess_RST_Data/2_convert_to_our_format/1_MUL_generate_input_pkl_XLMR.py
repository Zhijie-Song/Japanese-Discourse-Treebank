...
rinna_japanese_roberta_base_tokenizer = AutoTokenizer.from_pretrained("rinna/japanese-roberta-base", use_fast=False)
...
def read_edus(edus_path, tokenizer):
    edus_list = []
    with open(edus_path, 'r', encoding="utf-8") as f:
        for line in f:
...
if __name__ == '__main__':
    ...
    input_base_path = "C:/Users/16000/Desktop/Application/MyProject/dmrg/"

    output_base_path = "C:/Users/16000/Desktop/Application/MyProject/pickle_data"
    ...
    for subdir in subdirs:
        ...
        elif "jp-gum" in subdir:
            tokenizers_dict = {"xlm-roberta-base": xlm_roberta_base_tokenizer,
                               }

        elif "jp-gcdt" in subdir:
            tokenizers_dict = {"xlm-roberta-base": xlm_roberta_base_tokenizer,
                               }

        elif "jp-xlm" in subdir:
            tokenizers_dict = {"xlm-roberta-base": xlm_roberta_base_tokenizer,
                               }

        elif "jp" in subdir:
            tokenizers_dict = {"xlm-roberta-base": xlm_roberta_base_tokenizer,
                               "rinna-japanese-roberta-base": rinna_japanese_roberta_base_tokenizer,
                               }
        ...
        for tokenizer_key, tokenizer in tokenizers_dict.items():            
            ...
            for dmrg_path in dmrg_paths:
                print(dmrg_path)
                file_name = dmrg_path.split('/')[-1].split('\\')[1].split('.')[0]
